...
| :--- | :--- | :--- |
| **`ai.txt`** | Curated AI technical specification with explicit signatures, strict rules, and Luau examples | <a href="/ai.txt" target="_blank">Raw `/ai.txt`</a> |
| **`llms.txt`** | Standardized documentation index listing main topics and section links | <a href="/llms.txt" target="_blank">Raw `/llms.txt`</a> |
| **`llms-full.txt`** | Full concatenated plain-text representation of all public documentation | <a href="/llms-full.txt" target="_blank">Raw `/llms-full.txt`</a> |
